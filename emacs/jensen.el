;;; themer-my-color-set-dark-theme.el
...
(deftheme themer-my-color-set-dark)
...
(provide-theme 'themer-my-color-set-dark)

;; Local Variables:
;; no-byte-compile: t
;; End:

;;; themer-my-color-set-dark-theme.el ends here